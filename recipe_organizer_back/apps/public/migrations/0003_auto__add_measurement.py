...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'public_measurement', (
        ...
        db.send_create_signal(u'public', ['Measurement'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'public_measurement')
    ...
    models = {
        ...
        u'public.recipe': {
            ...
            'ingredients': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': u"orm['public.Ingredient']", 'null': 'True', 'through': u"orm['public.Measurement']", 'blank': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '50'})
        }
    }
