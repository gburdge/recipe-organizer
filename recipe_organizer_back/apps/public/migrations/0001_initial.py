...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'public_recipe', (
            ...
            ('description', self.gf('django.db.models.fields.TextField')(default='To be done later.')),
            ('instructions', self.gf('django.db.models.fields.TextField')(default='To be done later.')),
